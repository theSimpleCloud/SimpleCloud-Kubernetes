 ...
 */
class LobbyProcessTemplateConfiguration(
    name: String,
    maxMemory: Int,
    maxPlayers: Int,
    maintenance: Boolean,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as LobbyProcessTemplateConfiguration

        if (lobbyPriority != other.lobbyPriority) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + lobbyPriority
        return result
    }
