...
class RequestCreator(
    ...
    private suspend fun getRequestEntity(): PermissionEntity? {
        return try {
            this.authService.getRequestEntityFromHeader(createHeadersObject(this.context))
        } catch (e: Exception) {
    ...
    private fun createHeadersObject(context: Context): Headers {
        return object : Headers {
            override fun hasHeader(name: String): Boolean {
                return context.hasRequestHeader(name)
            }
