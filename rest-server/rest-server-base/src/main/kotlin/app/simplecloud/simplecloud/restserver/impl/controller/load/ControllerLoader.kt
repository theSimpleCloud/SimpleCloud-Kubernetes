...
package app.simplecloud.simplecloud.restserver.impl.controller.load
...
import app.simplecloud.simplecloud.restserver.api.controller.annotation.*
...
class ControllerLoader(
    ...
    private fun createRoute(method: Method): Route {
        ...
        val routeMethod = buildRouteMethod(method, routeBuilder)
    ...
    private fun buildRouteMethod(method: Method, routeBuilder: RouteBuilder): RouteMethod {
