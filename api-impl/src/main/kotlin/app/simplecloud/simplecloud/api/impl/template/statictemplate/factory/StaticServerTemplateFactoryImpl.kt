...
import app.simplecloud.simplecloud.api.impl.template.statictemplate.StaticServerTemplateImpl
 ...
 *
 */
class StaticServerTemplateFactoryImpl : StaticServerTemplateFactory {

    override fun create(
        configuration: ServerProcessTemplateConfiguration,
        internalService: InternalStaticProcessTemplateService,
    ): StaticServerTemplate {
        return StaticServerTemplateImpl(configuration, internalService)
    }
