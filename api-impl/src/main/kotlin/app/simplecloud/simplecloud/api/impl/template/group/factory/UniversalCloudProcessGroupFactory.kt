...
package app.simplecloud.simplecloud.api.impl.template.group.factory
    ...
    fun create(
        ...
        return when (configuration.type) {
            ProcessTemplateType.PROXY -> {
                this.proxyGroupFactory.create(configuration as ProxyProcessTemplateConfiguration, internalService)
            }

            ProcessTemplateType.LOBBY -> {
                this.lobbyGroupFactory.create(configuration as LobbyProcessTemplateConfiguration, internalService)
            }

            ProcessTemplateType.SERVER -> {
                this.serverGroupFactory.create(configuration as ServerProcessTemplateConfiguration, internalService)
            }
        }
    }
