...
import app.simplecloud.simplecloud.api.impl.template.group.CloudLobbyGroupImpl
 ...
 *
 */
class CloudLobbyGroupFactoryImpl : CloudLobbyGroupFactory {

    override fun create(
        configuration: LobbyProcessTemplateConfiguration,
        internalService: InternalCloudProcessGroupService,
    ): CloudLobbyGroup {
        return CloudLobbyGroupImpl(configuration, internalService)
    }
