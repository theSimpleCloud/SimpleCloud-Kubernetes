...
package app.simplecloud.simplecloud.api.impl.distribution.predicate
 ...
 */
class CloudProcessCompareDistributionIdPredicate(
    ...
    override fun apply(uuid: String, configuration: CloudProcessConfiguration): Boolean {
        return configuration.distributionId == compareId
    }
}