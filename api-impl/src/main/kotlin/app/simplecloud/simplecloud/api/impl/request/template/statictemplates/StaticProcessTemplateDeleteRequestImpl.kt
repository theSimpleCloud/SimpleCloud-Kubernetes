 ...
 *
 */
class StaticProcessTemplateDeleteRequestImpl(
    private val internalService: InternalStaticProcessTemplateService,
    private val template: StaticProcessTemplate,
) : StaticProcessTemplateDeleteRequest {
    ...
    override fun submit(): CompletableFuture<Unit> = CloudScope.future {
        internalService.deleteStaticTemplateInternal(template)
    }
}