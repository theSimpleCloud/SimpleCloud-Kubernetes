...
import app.simplecloud.simplecloud.api.impl.request.template.statictemplates.update.StaticServerTemplateUpdateRequestImpl
 ...
 *
 */
class StaticServerTemplateImpl(
...
) : AbstractStaticProcessTemplate(configuration, internalService), StaticServerTemplate {

    override fun createUpdateRequest(): StaticServerTemplateUpdateRequest {
        return StaticServerTemplateUpdateRequestImpl(this, this.internalService)
    }
