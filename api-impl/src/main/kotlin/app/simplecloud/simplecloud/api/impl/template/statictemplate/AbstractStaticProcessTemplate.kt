 ...
 *
 */
abstract class AbstractStaticProcessTemplate(
...
) : AbstractProcessTemplate(configuration), StaticProcessTemplate {
    ...
    override fun createDeleteRequest(): StaticProcessTemplateDeleteRequest {
        return this.internalService.createDeleteRequest(this)
    }
