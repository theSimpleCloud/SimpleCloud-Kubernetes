 ...
 *
 */
class OfflineCloudPlayerFactoryImpl(
    private val permissionFactory: Permission.Factory,
    private val permissionPlayerFactory: PermissionPlayer.Factory
) : OfflineCloudPlayerFactory {

    override fun create(
        configuration: OfflineCloudPlayerConfiguration,
        internalService: InternalCloudPlayerService
    ): OfflineCloudPlayer {
        return OfflineCloudPlayerImpl(
            configuration,
            internalService,
