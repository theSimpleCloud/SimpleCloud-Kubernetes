...
class UpdateOfflineCloudPlayerMessageHandler(
    private val internalPlayerService: InternalCloudPlayerService,
) : MessageHandler<OfflineCloudPlayerConfiguration, Unit> {

    override fun handleMessage(
        message: OfflineCloudPlayerConfiguration,
        sender: NetworkComponent,
    ): CompletableFuture<Unit> = CloudScope.future {
        internalPlayerService.updateOfflinePlayerInternal(message)
    }
}