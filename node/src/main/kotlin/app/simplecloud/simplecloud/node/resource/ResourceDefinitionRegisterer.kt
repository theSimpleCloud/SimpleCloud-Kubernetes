...
class ResourceDefinitionRegisterer(
    ...
    private fun registerOnlineCountStrategyDefinition() {
        ...
        val v1LobbyVersionBuilder = resourceBuilder.newResourceVersionBuilder()
        v1LobbyVersionBuilder.setName("v1beta1")
        v1LobbyVersionBuilder.setSpecSchemaClass(V1Beta1ProcessOnlineCountStrategySpec::class.java)
        v1LobbyVersionBuilder.setPreProcessor(
            V1Beta1OnlineCountStrategyPreProcessor(this.distributedRepositories.distributedOnlineCountStrategyRepository)
        )

        resourceBuilder.addVersionAsDefaultVersion(v1LobbyVersionBuilder.build())
    ...
    private fun registerPermissionGroupDefinition() {
        ...
        val v1LobbyVersionBuilder = resourceBuilder.newResourceVersionBuilder()
        v1LobbyVersionBuilder.setName("v1beta1")
        v1LobbyVersionBuilder.setSpecSchemaClass(V1Beta1PermissionGroupSpec::class.java)
        v1LobbyVersionBuilder.setPreProcessor(
    ...
    private fun registerStaticLobbyDefinition() {
        ...
        val v1LobbyVersionBuilder = resourceBuilder.newResourceVersionBuilder()
        v1LobbyVersionBuilder.setName("v1beta1")
        v1LobbyVersionBuilder.setSpecSchemaClass(V1Beta1StaticLobbySpec::class.java)
        v1LobbyVersionBuilder.setPreProcessor(
    ...
    private fun registerStaticProxyDefinition() {
        ...
        val v1LobbyVersionBuilder = resourceBuilder.newResourceVersionBuilder()
        v1LobbyVersionBuilder.setName("v1beta1")
        v1LobbyVersionBuilder.setSpecSchemaClass(V1Beta1StaticProxySpec::class.java)
        v1LobbyVersionBuilder.setPreProcessor(
    ...
    private fun registerStaticServerDefinition() {
        ...
        val v1LobbyVersionBuilder = resourceBuilder.newResourceVersionBuilder()
        v1LobbyVersionBuilder.setName("v1beta1")
        v1LobbyVersionBuilder.setSpecSchemaClass(V1Beta1StaticServerSpec::class.java)
        v1LobbyVersionBuilder.setPreProcessor(
    ...
    private fun registerLobbyGroupDefinition() {
        ...
        val v1LobbyVersionBuilder = resourceBuilder.newResourceVersionBuilder()
        v1LobbyVersionBuilder.setName("v1beta1")
        v1LobbyVersionBuilder.setSpecSchemaClass(V1Beta1LobbyGroupSpec::class.java)
        v1LobbyVersionBuilder.setPreProcessor(
