...
class UpdateStaticTemplateMessageHandler(
    private val staticTemplateService: InternalStaticProcessTemplateService,
) : MessageHandler<AbstractProcessTemplateConfiguration, Unit> {

    override fun handleMessage(
        message: AbstractProcessTemplateConfiguration,
        sender: NetworkComponent,
    ): CompletableFuture<Unit> = CloudScope.future {
        staticTemplateService.updateStaticTemplateInternal(message)
    }
}