...
package app.simplecloud.simplecloud.module.api.impl.repository.distributed.predicate
 ...
 *
 */
class ErrorCompareProcessNamePredicate(
    private val compareName: String,
) : Predicate<UUID, ErrorConfiguration> {

    override fun apply(uuid: UUID, configuration: ErrorConfiguration): Boolean {
        return configuration.processName == compareName
    }
}