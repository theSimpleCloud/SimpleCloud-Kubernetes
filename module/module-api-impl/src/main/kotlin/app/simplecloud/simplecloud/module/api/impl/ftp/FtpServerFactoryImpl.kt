 ...
 *
 */
class FtpServerFactoryImpl : FtpServerFactory {

    override fun create(configuration: FtpServerConfiguration, service: InternalFtpServerService): FtpServer {
        return FtpServerImpl(configuration, service)
    }
