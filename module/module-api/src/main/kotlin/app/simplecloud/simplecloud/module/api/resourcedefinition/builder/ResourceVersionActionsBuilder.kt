 ...
 *
 */
interface ResourceVersionActionsBuilder {

    fun disableCreate(): ResourceVersionActionsBuilder

    fun disableUpdate(): ResourceVersionActionsBuilder

    fun disableDelete(): ResourceVersionActionsBuilder

    fun setCreateActionName(name: String): ResourceVersionActionsBuilder
